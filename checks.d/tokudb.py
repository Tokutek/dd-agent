...
STATUS_VARS = {
    ...
    'Tokudb_CACHETABLE_SIZE_CURRENT': ('mysql.tokudb.cachetable.size_current', GAUGE),
    'Tokudb_CACHETABLE_SIZE_WRITING': ('mysql.tokudb.cachetable.size_writing', GAUGE),
    'Tokudb_CACHETABLE_SIZE_NONLEAF': ('mysql.tokudb.cachetable.size_nonleaf', GAUGE),
    'Tokudb_CACHETABLE_SIZE_LEAF': ('mysql.tokudb.cachetable.size_leaf', GAUGE),
    'Tokudb_CACHETABLE_MISS_TIME': ('mysql.tokudb.cachetable.miss_time.', RATE),
    'Tokudb_DB_OPENS': ('mysql.tokudb.db_opens', GAUGE),
    'Tokudb_DB_CLOSES': ('mysql.tokudb.db_closes', GAUGE),
    'Tokudb_LEAF_NODE_COMPRESSION_RATIO': ('mysql.tokudb.leaf_node_compression_ratio', GAUGE),
    'Tokudb_NONLEAF_NODE_COMPRESSION_RATIO': ('mysql.tokudb.nonleaf_node_compression_ratio', GAUGE),
    'Tokudb_OVERALL_NODE_COMPRESSION_RATIO': ('mysql.tokudb.overall_node_compression_ratio', GAUGE),
    'Tokudb_BASEMENTS_FETCHED_TARGET_QUERY_SECONDS': ('mysql.tokudb.basement_nodes_fetched.target_query', RATE),
    'Tokudb_BASEMENTS_FETCHED_PRELOCKED_RANGE_SECONDS': ('mysql.tokudb.basement_nodes_fetched.prelocked_range', RATE),
    'Tokudb_BASEMENTS_FETCHED_PREFETCH_SECONDS': ('mysql.tokudb.basement_nodes_fetched.prefetch', RATE),
    'Tokudb_BASEMENTS_FETCHED_FOR_WRITE_SECONDS': ('mysql.tokudb.basement_nodes_fetched.for_write', RATE),
    'Tokudb_BUFFERS_FETCHED_TARGET_QUERY_SECONDS': ('mysql.tokudb.buffers_fetched.target_query', RATE),
    'Tokudb_BUFFERS_FETCHED_PRELOCKED_RANGE_SECONDS': ('mysql.tokudb.buffers_fetched.prelocked_range', RATE),
    'Tokudb_BUFFERS_FETCHED_PREFETCH_SECONDS': ('mysql.tokudb.buffers_fetched.prefetch', RATE),
    'Tokudb_BUFFERS_FETCHED_FOR_WRITE_SECONDS': ('mysql.tokudb.buffers_fetched.for_write', RATE),
    'Tokudb_PIVOTS_FETCHED_FOR_QUERY_SECONDS': ('mysql.tokudb.pivots_fetched.for_query', RATE),
    'Tokudb_PIVOTS_FETCHED_FOR_PREFETCH_SECONDS': ('mysql.tokudb.pivots_fetched.for_prefetch', RATE),
    'Tokudb_PIVOTS_FETCHED_FOR_WRITE_SECONDS': ('mysql.tokudb.pivots_fetched.for_write', RATE),
    'Tokudb_LEAF_COMPRESSION_TO_MEMORY_SECONDS': ('mysql.tokudb.compression_to_memory.leaf', RATE),
    'Tokudb_LEAF_SERIALIZATION_TO_MEMORY_SECONDS': ('mysql.tokudb.serialization_to_memory.leaf', RATE),
    'Tokudb_LEAF_DECOMPRESSION_TO_MEMORY_SECONDS': ('mysql.tokudb.decompression_to_memory.leaf', RATE),
    'Tokudb_LEAF_DESERIALIZATION_TO_MEMORY_SECONDS': ('mysql.tokudb.deserialization_to_memory.leaf', RATE),
    'Tokudb_NONLEAF_COMPRESSION_TO_MEMORY_SECONDS': ('mysql.tokudb.compression_to_memory.nonleaf', RATE),
    'Tokudb_NONLEAF_SERIALIZATION_TO_MEMORY_SECONDS': ('mysql.tokudb.serialization_to_memory.nonleaf', RATE),
    'Tokudb_NONLEAF_DECOMPRESSION_TO_MEMORY_SECONDS': ('mysql.tokudb.decompression_to_memory.nonleaf', RATE),
